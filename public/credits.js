...
export const MUSIC = [
  ...
  {
    title: 'Canon in D for Two Renaissance Harps',
    file: 'Canon in D for Two Renaissance Harps.mp3',
  },
...
export const SFX_CREDITS = [
  ...
  {
    title: 'Card Game Sounds',
    by: 'HaelDB',
    url: 'https://opengameart.org/users/haeldb',
    license: 'CC0',
  },
  {
    title: 'Playing Card Sounds',
    by: 'BMacZero',
    url: 'https://opengameart.org/users/bmaczero',
    license: 'CC0',
  },
  {
    title: 'Sound Effects Pack',
    by: 'OwlishMedia',
    url: 'https://opengameart.org/users/owlishmedia',
    license: 'CC0',
  },
];
...
export const MODEL_CREDITS = [
  { title: 'Chess Set', by: 'justinaray', url: 'https://opengameart.org/users/justinaray', license: 'CC-BY 4.0' },
  { title: 'Pipped Dice', by: 'Modanung', url: 'https://opengameart.org/users/modanung', license: 'CC0 (Public Domain)' },
];
...
export const ART_CREDITS = [
  ...
  {
    title: 'Mahjong tileset',
    by: 'CodeInfernoGames',
    url: 'https://codeinferno.com',
    license: 'CC BY 3.0',
    note: 'Author requests a link to codeinferno.com.',
  },
];
